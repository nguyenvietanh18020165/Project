<section class="container">
    <h3 class="text-center mt-3">Các sản phẩm yêu thích</h3>
    <div class="row latest_product product_hot_home">
        ...
        @foreach($product as $val)
            <div id="prdId<?php echo $val->id; ?>" class="col-6 col-sm-4 col-md-3 col-lg-3 mt-2">
                <div class="position-relative">
                    ...
                    <span class="like mt-2">
                        <i class="fa-solid fa-heart" onclick={handleClickLike('#prdId<?php echo $val->id; ?>')}></i>
                    </span>
                    </div>
                </div>
                <div class="row">
